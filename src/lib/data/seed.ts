...
function buildRecurring(): RecurringSeed[] {
  ...
  return [
    ...
    },
    {
      ...
      dayOfPeriod: 12,
      categoryId: "bills.subscriptions",
      accountId: ACCOUNT_IDS.card,
      type: "EXPENSE",
    },
    {
...
const BUCKETS: Bucket[] = [
  {
    ...
    typicalAmount: 900,
    templates: [
      { description: "Dinner at Toit", categoryId: "dining.restaurant", merchant: "Toit", hours: [19, 22], account: "card" },
      { description: "Lunch", categoryId: "dining.restaurant", hours: [12, 15], account: "card" },
      { description: "Swiggy order", categoryId: "dining.delivery", merchant: "Swiggy", hours: [13, 22], account: "card" },
      { description: "Zomato order", categoryId: "dining.delivery", merchant: "Zomato", hours: [13, 22], account: "card" },
      { description: "Coffee", categoryId: "dining.cafe", merchant: "Blue Tokai", hours: [8, 18], account: "hdfc" },
      { description: "Breakfast", categoryId: "dining.restaurant", hours: [8, 11], account: "hdfc" },
      { description: "Biryani", categoryId: "dining.takeaway", hours: [13, 21], account: "cash" },
    ],
  },
  {
    id: "dating",
    ...
    weekendBias: true,
    templates: [
      { description: "Dinner", categoryId: "dating.dining", contexts: ["dating"], hours: [19, 22], account: "card" },
      { description: "Drinks", categoryId: "dating.drinks", contexts: ["dating", "alcohol"], hours: [20, 23], account: "card" },
      { description: "Movie", categoryId: "dating.movies", merchant: "PVR", contexts: ["dating"], hours: [17, 22], account: "card" },
      { description: "Coffee date", categoryId: "dating.dining", contexts: ["dating"], hours: [16, 19], account: "hdfc" },
      { description: "Gift", categoryId: "dating.gifts", contexts: ["dating", "gift"], hours: [12, 20], account: "card" },
    ],
  },
  {
    id: "transport",
  ...
  },
  {
    ...
    typicalAmount: 900,
    templates: [
      { description: "Whey protein", categoryId: "essentials.diet", merchant: "MuscleBlaze", hours: [10, 20], account: "card" },
      { description: "Eggs and oats", categoryId: "essentials.diet", merchant: "Zepto", hours: [8, 20], account: "hdfc" },
      { description: "Creatine", categoryId: "essentials.diet", hours: [10, 20], account: "card" },
      { description: "Meal prep groceries", categoryId: "essentials.diet", merchant: "BigBasket", hours: [9, 19], account: "hdfc" },
    ],
  },
  {
    id: "shopping",
    typicalAmount: 1400,
    templates: [
      { description: "T-shirts", categoryId: "shopping.clothes", merchant: "Myntra", hours: [11, 22], account: "card" },
      { description: "Sneakers", categoryId: "shopping.clothes", merchant: "Decathlon", hours: [12, 20], account: "card" },
      { description: "Amazon order", categoryId: "shopping.other", merchant: "Amazon", hours: [10, 23], account: "card" },
  ...
  },
  {
    ...
    weekendBias: true,
    templates: [
      { description: "Dinner with friends", categoryId: "social.dining", contexts: ["friends"], hours: [19, 23], account: "card" },
      { description: "Drinks with the gang", categoryId: "social.drinks", contexts: ["friends", "alcohol"], hours: [20, 23], account: "card" },
      { description: "House party contribution", categoryId: "social.parties", contexts: ["friends", "alcohol"], hours: [18, 23], account: "hdfc" },
      { description: "Brunch with friends", categoryId: "social.dining", contexts: ["friends"], hours: [11, 15], account: "card" },
    ],
  },
  {
    id: "entertainment",
    ...
    weekendBias: true,
    templates: [
      { description: "Movie tickets", categoryId: "entertainment.movies", merchant: "BookMyShow", hours: [16, 22], account: "card" },
      { description: "Comedy show", categoryId: "entertainment.events", merchant: "BookMyShow", hours: [19, 22], account: "card" },
  ...
  },
  {
    ...
    typicalAmount: 1400,
    templates: [
      { description: "Groceries", categoryId: "essentials.groceries", merchant: "Blinkit", hours: [9, 21], account: "hdfc" },
      { description: "Toiletries", categoryId: "essentials.toiletries", merchant: "Zepto", hours: [10, 21], account: "hdfc" },
      { description: "Sunscreen", categoryId: "essentials.skincare", hours: [11, 20], account: "hdfc" },
      { description: "Medicines", categoryId: "essentials.medicines", merchant: "PharmEasy", hours: [9, 20], account: "hdfc" },
    ],
  },
];
